...
class DataForm:
    def __init__(self, parent):
        ...
        Label(parent, text="Student Name", font="Arial 14 bold").grid(row=1, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Department", font="Arial 14 bold").grid(row=2, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="DOB", font="Arial 14 bold").grid(row=3, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Email ID", font="Arial 14 bold").grid(row=4, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Phone No.", font="Arial 14 bold").grid(row=5, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Class 10(%)", font="Arial 14 bold").grid(row=6, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Class 12(%)", font="Arial 14 bold").grid(row=7, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Address", font="Arial 14 bold").grid(row=8, column=0, padx=10, pady=10, sticky="e")
        Label(parent, text="Guardian Name", font="Arial 14 bold").grid(row=9, column=0, padx=10, pady=10, sticky="e")
